    ...
    return (
        <div className="game-settings-page">
            ...
            <div style={{ display: "flex", justifyContent: "center", width: "100%" }}>
                <img 
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/IBM_granite_2_cubes_logo.svg/1200px-IBM_granite_2_cubes_logo.svg.png" 
                    style={{width:"150px"}} 
                    alt="IBM Granite Logo"
                />
            </div>
            <h2>ii) Quiz Question Generator</h2>
            <p>Customise the prompts for the questions generated by IBM granite GenAI.</p>
        ...
        <div style={{ flex: 1 }}></div> {/* This empty div with flex:1 will push the content up */}
    </div>
    );
}
